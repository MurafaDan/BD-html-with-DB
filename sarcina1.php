...
if ($_SERVER["REQUEST_METHOD"] == "GET") {
    ...
    $sql = "SELECT eroi.nume_erou, locatii.nume_loc, transport.nume_transport, obiecte.nume_obiect
  FROM eroi
...
";
    ...
    if ($result) {
        ...
        echo "<tr style='border: 1px solid #ddd;'><th>Nr.</th><th>Erou</th><th>Locatia</th><th>Transport</th><th>Obiect</th></tr>";
        $i = 1;
